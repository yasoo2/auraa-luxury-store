      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="font-display text-3xl lg:text-4xl font-bold text-gray-900 mb-4" data-testid="product-title">
                {product.name}
              </h1>
              ...
              <div className="flex items-center space-x-4 mb-6">
                <span className="price-highlight text-4xl font-bold text-amber-600" data-testid="product-price">
                  {product.price} ر.س
                </span>
