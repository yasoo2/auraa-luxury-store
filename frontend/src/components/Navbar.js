          ...
          {!FLAGS.LOGO_BOTTOM_RIGHT && (
            <Link to="/" className="flex flex-col items-start py-2">
              <div className="font-display font-black leading-none flex items-baseline gap-1">
                <span className="text-3xl md:text-4xl carousel-luxury-text leading-none whitespace-nowrap">لورا</span>
          ...
          {FLAGS.LOGO_BOTTOM_RIGHT && (
            <Link to="/" className="hidden md:block absolute bottom-1 right-2 flex flex-col items-end">
              <div className="flex items-end space-x-2">
                <span className="font-display text-5xl md:text-6xl font-black logo-aurra-contrast leading-none tracking-tight">لورا</span>
